...
var Je = (o, e, t) =>
  e in o
    ...
    : (o[e] = t);
var x = (o, e, t) => (Je(o, typeof e != "symbol" ? e + "" : e, t), t);
...
const rt = {
  ...
  lt = r.forwardRef(function ({ currentActiveScene: e }, t) {
    const s = r.useRef(),
      n = r.useRef(null);
    return (
      r.useLayoutEffect(() => {
...
const gt = 1e3,
  ...
  ft = { duration: 0.5, ease: "circ.out", angle: 360, scaleOnStart: 0.5 },
  mt = { duration: 0.3, ease: "none" },
...
class Be extends T {
  ...
  dealAnim(e, t, s) {
    const { duration: n, ease: a, scaleOnStart: c, angle: d } = ft,
...
const At = { duration: 1, ease: "circ.out" },
  ee = class ee {
    static initTable(e) {
...
(ee.tableAdapter = new vt()), (ee.createTableTween = null);
let R = ee;
const me = class me {
  static addPlayer(e) {
    const t = e.id;
...
const Ht = { path: "card", key: "deal_card" },
  ...
  fs = { path: "interface/buttons", key: "call_button_push" },
  ms = { path: "interface/buttons", key: "call_button" },
  ...
  vs = { path: "interface", key: "batting_arrow" },
  As = { path: "interface", key: "betting_background" },
    ...
    const [t, s] = r.useState(!1),
      ...
      d = async () => {
        const l = n.current.querySelector("#login").value,
          ...
          f = await (await Js({ username: l, password: u })).json(),
          { success: m, jwt: p } = f;
...
const ti = B.forwardRef((o, e) => {
  ...
  t || We(),
    ...
    r.useEffect(() => {
      ...
      h.getPlayerAndGameProfileInformation.dispatch(L), Ye(), J();
    }, []);
  function We() {
    s(!0),
  ...
  return (
    ...
    i.jsxs("div", {
      ...
      children: [
            ...
            i.jsxs("div", {
              ...
              children: [
                i.jsxs("div", {
                  ...
                  onMouseLeave: () => P(!1),
                  children: [
                    i.jsx("img", { id: "card", src: n ? Ge : Re, alt: "card" }),
                    i.jsx("button", {
                      id: "second-button",
                      children: "Quick Play",
                    }),
                ...
                i.jsxs("div", {
                  ...
                  onMouseLeave: () => V(!1),
                  children: [
                    i.jsx("img", { id: "card", src: n ? De : Me, alt: "card" }),
                    i.jsx("button", {
                      id: "first-button",
                      onClick: $,
                      children: "Join Now",
                ...
                i.jsxs("div", {
                  ...
                  onMouseLeave: () => xe(!1),
                  children: [
                    i.jsx("img", { id: "card", src: n ? Ne : Ve, alt: "card" }),
                    i.jsx("button", {
                      id: "first-button",
                      onClick: $,
                      children: "Join Now",
        ...
        c && i.jsx(ei, { data: f, availableChips: l.money }),
        i.jsx(ke, {}),
      ],
    })
  );
...
const ni = r.forwardRef((o, e) => {
    ...
    const [n, a] = r.useState(!1),
      ...
      l = (p) => {
        ...
        if (p === y) (P.action = y), h.playerTurnAction.dispatch(P);
          ...
          //! BET
          (P.action = "bet"), (P.data = ii(t)), h.playerTurnAction.dispatch(P);
  ...
  ri = B.forwardRef((o, e) => {
    ...
    M.add("channels", m);
    const y = (V) => {
        s(V); //! ZUPDATOWAĆ CZIPY w balance danymi z servera
...
const hi = B.forwardRef((o, e) => i.jsx(di, { ref: e, ...o }));
function ui() {
  const o = r.useRef(),
    e = r.useRef(null),
    t = r.useRef(null);
