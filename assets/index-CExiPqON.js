...
var Ae = (r, e, t) =>
  e in r
    ...
    : (r[e] = t);
var m = (r, e, t) => (Ae(r, typeof e != "symbol" ? e + "" : e, t), t);
...
import { l as je } from "./socket.io-client-DFi9RC7o.js";
import { d as P } from "./mini-signals-DMh6wOcT.js";
import { g as C } from "./gsap-ZORhgBxb.js";
import { h as Re } from "./howler-BozPm2lL.js";
...
const Me = {
  ...
  Ve = (r) => new ve({ ...Me, parent: r }),
  Oe = d.forwardRef(function ({ currentActiveScene: e }, t) {
    const s = d.useRef(),
      n = d.useRef(null);
    return (
      d.useLayoutEffect(() => {
        s.current === void 0 &&
          ((s.current = Ve("game-container")),
...
class _ {
  ...
  static removeScene(e) {
    ...
    t == null || t.removeListeners(), $.removeChild(t);
  }
  static getScene(e) {
    return N.getScene(e);
  }
...
const Ge = 8081,
  Ee = 8081;
let xe = `${location.protocol}//${location.hostname}`,
  Ce = `ws://${location.hostname}:${Ee}`;
location.protocol == "http:"
  ? (xe += `:${Ge}`)
  : (Ce = location.origin.replace(/^http/, "ws")); //! ///////////////////////////////////////////////////
//! ///////////////////////////////////////////////////
class c {}
m(c, "onPlayerJoinRoom", new P.MiniSignal()),
  m(c, "onGetPlayers", new P.MiniSignal()),
  m(c, "onAllPlayerJoined", new P.MiniSignal()),
  m(c, "onChangePlayerTurn", new P.MiniSignal()),
  m(c, "onInitNextRound", new P.MiniSignal()),
  m(c, "onPlayerLeave", new P.MiniSignal()),
  m(c, "onUpdatePlayerTurnAction", new P.MiniSignal()),
  m(c, "onGameResult", new P.MiniSignal()),
  m(c, "onRoomsState", new P.MiniSignal()),
  m(c, "onGameState", new P.MiniSignal()),
  m(c, "onResetGame", new P.MiniSignal()),
  m(c, "onAnnouncement", new P.MiniSignal()),
  m(c, "onBackButtonClick", new P.MiniSignal()),
  m(c, "onPlayerAndGameProfileInformation", new P.MiniSignal()),
  m(c, "onKick", new P.MiniSignal()),
  m(c, "getPlayerAndGameProfileInformation", new P.MiniSignal()),
  m(c, "playerTurnAction", new P.MiniSignal()),
  m(c, "joinGame", new P.MiniSignal()),
  m(c, "getRoomsState", new P.MiniSignal());
class De {
  constructor() {
    (this.client = null), (this.myId = ""), this.bindSignals();
  }
  async connectWithServer() {
    this.client = await je(`${Ce}`).on("connect", () => {
...
const Fe = 1e3,
  ...
  He = { duration: 0.1, ease: "none", yoyo: !0, repeat: 1 },
  We = { duration: 0.5, ease: "circ.out", angle: 360, scaleOnStart: 0.5 },
  Ue = { duration: 0.3, ease: "none" },
  Ke = { duration: 0.3, ease: "none", scale: 1.5 },
...
class we extends S {
  ...
  async turnOverAnim(e) {
    const { duration: t, ease: s, yoyo: n, repeat: a } = He;
    await C.to(this, {
      width: 0,
      duration: t,
      ease: s,
  ...
  dealAnim(e, t, s) {
    const { duration: n, ease: a, scaleOnStart: o, angle: h } = We,
...
class Xe {
  ...
  createTable() {
    return (this.table = new $e()), this.table;
  }
  get getCards() {
...
const Je = { duration: 1, ease: "circ.out" },
  K = class K {
    static initTable(e) {
...
(K.tableAdapter = new Xe()), (K.createTableTween = null);
let L = K;
const de = class de {
  static addPlayer(e) {
    const t = e.id;
...
let H = z;
const Qe = ["check_sign", "call_sign", "raise_sign"],
  X = {
...
class tt extends R {
  ...
  async startScaleUpCardsAnim() {
    const { duration: e, ease: t, scale: s } = Ke,
...
class rt {
  constructor(e) {
    (this.playerComponents = new at(e)),
      (this.config = e),
      (this.id = this.config.id),
...
class ot {
  constructor() {
    m(this, "handleLoadingGameVisible", (e) => {
      this.pages.handleLoadingGameVisible(e);
    });
    m(this, "handleLobbyPageVisible", (e) => {
      this.pages.handleLobbyPageVisible(e);
    });
    m(this, "handleRoomsPageVisible", (e) => {
...
class ct extends ce {
  ...
  createPlayer(e) {
    ...
    const A = new rt(u);
    return A.changeAvatarSprite(y), p.addPlayer(A), A;
  }
  initGameState(e) {
    const {
        tableCards: t,
  ...
  deletePlayer(e) {
    const t = X.playerLeave;
    D.playAudio(t), p.deletePlayer(e);
  }
  updatePlayerTurnAction(e) {
    const [t, s, n] = Qe,
      [a, o, h, l, g] = Se,
      { playerId: y, type: f, bet: b, chips: x } = e,
      u = p.getPlayer(y),
      A = X.playerTurnEnd;
    if ((D.playAudio(A), f === o)) {
      const w = t;
      u.setActionSignAndTextureVisible(w, !0);
    } else if (f === g) this.updatePlayerMoneyAndBetText(y, b, x);
    else if (f === h) {
      const w = s;
      u.setActionSignAndTextureVisible(w, !0),
        this.updatePlayerMoneyAndBetText(y, b, x);
    } else
...
he.game = null;
let U = he;
const ht = { path: "game/backgrounds", key: "background" },
  ut = { path: "game/backgrounds", key: "bet_background" },
  gt = { path: "game/avatar", key: "default_avatar" },
  pt = { path: "game/avatar", key: "avatar_background" },
  yt = { path: "game/chips", key: "bet" },
  mt = { path: "game/croupier", key: "croupier" },
  ft = { path: "game/signs", key: "check_sign" },
  bt = { path: "game/signs", key: "dealer_sign" },
  xt = { path: "game/signs", key: "call_sign" },
  Ct = { path: "game/signs", key: "winner_sign" },
  Pt = { path: "game/tables", key: "table" },
  wt = { path: "game/timer", key: "timer_bar_background" },
  St = { path: "game/timer", key: "timer_bar_container" },
  Tt = { path: "game/timer", key: "timer_bar" },
  At = {
    gameBackground: ht,
    betBackground: ut,
    defaultPlayerAvatar: gt,
    avatarBackground: pt,
    betChip: yt,
    croupier: mt,
    playerCheckSign: ft,
  ...
  kt = { path: "interface/buttons", key: "bet_button_push" },
  vt = { path: "interface/buttons", key: "bet_button" },
  Bt = { path: "interface/buttons", key: "betting_hide_button" },
  It = { path: "interface/buttons", key: "betting_show_button" },
  _t = { path: "interface/buttons", key: "call_button_push" },
  Lt = { path: "interface/buttons", key: "call_button" },
  jt = { path: "interface/buttons", key: "check_button_push" },
  Rt = { path: "interface/buttons", key: "check_button" },
  Mt = { path: "interface/buttons", key: "fold_button_push" },
  Vt = { path: "interface/buttons", key: "fold_button" },
  Ot = { path: "interface/buttons", key: "raise_button_push" },
  Gt = { path: "interface/buttons", key: "raise_button" },
  Et = { path: "interface", key: "batting_arrow" },
  Dt = { path: "interface", key: "betting_background" },
  Ft = { path: "interface", key: "betting_text_field" },
  Nt = { path: "interface", key: "bottom_bar" },
  Ht = {
    betButtonPush: kt,
    betButton: vt,
    bettingHideButton: Bt,
    bettingShowButton: It,
    callButtonPush: _t,
    callButton: Lt,
    checkButtonPush: jt,
    checkButton: Rt,
    ...
    raiseButton: Gt,
    battingArrow: Et,
    bettingBackground: Dt,
    bettingTextField: Ft,
    bottomBar: Nt,
  },
  Wt = { path: "loginScreen/background", key: "login_screen_background" },
  Ut = { path: "loginScreen/buttons", key: "login_button" },
  Kt = { path: "loginScreen/buttons", key: "login_button_push" },
  zt = { loginScreenBackground: Wt, loginButton: Ut, loginButtonPush: Kt },
  Yt = { path: "registerScreen/background", key: "register_screen_background" },
  $t = { path: "registerScreen/buttons", key: "register_button" },
  Xt = { path: "registerScreen/buttons", key: "register_button_push" },
  Jt = { path: "registerScreen/buttons", key: "back_button" },
  Zt = { path: "registerScreen/buttons", key: "back_button_push" },
  qt = {
    registerScreenBackground: Yt,
    registerButton: $t,
    registerButtonPush: Xt,
    backButton: Jt,
    backButtonPush: Zt,
  },
  Qt = [At, Ht, zt, qt],
...
class is extends ce {
  ...
  async loadImage({ path: e, key: t }) {
    const { _path: s, extension: n } = ss.images;
    let a = s + e + "/" + t + n,
      o = await ue.load(a);
    W.addImage(t, o);
  }
...
class ie {
  ...
  static calculateVerticalScaleFactor() {
    return Math.min(window.innerHeight / me, window.innerWidth / ye);
  }
  ...
  static resizeUI(e, t) {
    const s = this._isPortraitOrientation ? ye : J,
      n = this._isPortraitOrientation ? me : Z,
...
m(ie, "_isPortraitOrientation", se());
const cs = v.forwardRef((r, e) => {
  ...
  ls = { "Content-Type": "application/json", Accept: "application/json" },
  ds = (r, e) =>
    fetch(`${xe}/${e}`, {
      method: "post",
      headers: ls,
    ...
    const [t, s] = d.useState(!1),
      ...
      h = async () => {
        const l = n.current.querySelector("#login").value,
          ...
          y = await (await hs({ username: l, password: g })).json(),
          { success: f, jwt: b } = y;
    ...
    return (
      ...
      i.jsxs("div", {
        ...
        children: [
          ...
          n && i.jsx(ys, { data: l, availableChips: o.money }),
        ],
      })
    );
  });
...
const ws = d.forwardRef((r, e) => {
    ...
    const n = (l) => {
        ...
        if (l === g) (u.action = g), c.playerTurnAction.dispatch(u);
          ...
          //! BET
          (u.action = "bet"), (u.data = Ps(t)), c.playerTurnAction.dispatch(u);
        } else l === y && ((u.action = y), c.playerTurnAction.dispatch(u));
      },
      a = (l) => {},
      o = (l) => {
...
class As extends d.Component {
  ...
  render() {
    ...
    return i.jsxs("div", {
      ...
      style: h,
      children: [
        i.jsx(xs, { ref: this.topBarRef }),
        i.jsx(bs, { ref: this.bottomBarRef }),
        i.jsx(Ts, { ref: this.middleBarRef }),
      ],
    });
  }
}
const ks = v.forwardRef((r, e) => i.jsx(As, { ref: e, ...r }));
function vs() {
  const r = d.useRef(),
    e = d.useRef(null),
    t = d.useRef(null);
...
ke.createRoot(document.getElementById("root")).render(i.jsx(vs, {}));
